 ...
 * 
 *
 * @command consecutive_battles
 * @text consecutive_battles
 * @desc Asign list number of trooper
 *
 * @arg consecutive_battles
 * @type text
 * @text consecutive_battles
 * @desc Lista de enemigos
 * @default
 *
 ...
 * 
 * =============================================================================
 * To show or hide the Wave number use the commands below.
 *
 * hide_wave_number
 *
 * show_wave_number
 *
 * =============================================================================
 * To show or hide the phase animation use the commands below.
 *
...
//==============================
// * PluginCommand moded for MZ by ccarsas
//==============================


PluginManager.registerCommand("MOG_ConsecutiveBattles", "consecutive_battles",  args =>{
	const arg0 = String(args.consecutive_battles);
	$gameSystem.clearConsBat();
	$gameSystem._consBat.enable = true;
	let battles = arg0.split(/,/);
	for (let i = 0; i < battles.length; i++) {
		let troopId = Number(battles[i]);
...
BattleManager.makeRewardsCB = function() {
	...
	for (var i = 0; i < $gameSystem._consBat.rewards.length; i++) {
		...
		console.log(this._rewards.gold);
		console.log(this._rewards.exp);
